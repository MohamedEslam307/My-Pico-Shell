...
char calculate_num_of_io_redirections(char **parsed_input_string,
                                      char arguments_size,char* redirections_num);
int main()
{
    char *command_line;
	...
	ret = calculate_num_of_io_redirections(parsed_input_string,arguments_size,&num_of_redirections);
	addNode(&list, parsed_input_string, &arguments_size,num_of_redirections);
